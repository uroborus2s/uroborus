...
} from '@/entity/types/callBackParams';
import {
  CsvExportParams,
  ProcessCellForExportParams,
  ProcessGroupHeaderForExportParams,
  ProcessHeaderForExportParams,
} from '@/entity/types/exportParams';
import {
  PasteEndEvent,
  PasteStartEvent,
  ToolPanelVisibleChangedEvent,
} from '@/entity/types/enevtType';
import { ExcelExportParams, ExcelStyle } from '@/entity/types/excelCreator';
import {
  ChartMenuOptions,
  UChartTheme,
  UChartThemeOverrides,
} from '@/entity/types/chartOptions';
import { AggFunc } from '@/entity/cell';
import { Datasource } from '@/entity/types/datasource';
import { ServerSideDatasource } from '@/entity/types/serverSideDatasource';
import { ViewportDatasource } from '@/entity/types/viewportDatasource';
import { Column } from '@/entity/column';
import { RowNode } from '@/entity/rowNode';
import { GridCommon } from '@/entity/types/common';
...
export interface GridOptions {
  ...
  // *****************************************************************************************************
  // If you change the callbacks on this types, you must also update PropertyKeys to be consistent. *
  // *****************************************************************************************************
