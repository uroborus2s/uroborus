...
interface ViewMenuProps {
  ...
  openEditInfo: MouseEventHandler<HTMLElement>;
}
...
const ViewMenu: FC<ViewMenuProps> = ({
  ...
  const viewName = useRecoilValue(view.name(currentViewId));
    ...
    <>
      ...
      >
        ...
        <ViewMenuItem
          ...
          onClick={(e) => {
            if (closePopover) closePopover();
            if (openEditInfo) openEditInfo(e);
          }}
        >
        ...
        <ViewMenuItem
          ...
          disableTouchRipple
          onClick={() => {
            deleteView({ path: { id: currentViewId, tableId: tableId } }).then(
              () => {
