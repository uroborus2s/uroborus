...
const GridIcon = (props: SvgIconProps): JSX.Element => (
  <SvgIcon
    viewBox="0 0 24 24"
    sx={{ color: '#1283da', fontSize: '16px' }}
    {...props}
  >
    <path
      fill="currentColor"
...
const KanbanIcon = (props: SvgIconProps): JSX.Element => (
  <SvgIcon
    viewBox="0 0 24 24"
    sx={{ color: '#11af22', fontSize: '16px' }}
    {...props}
  >
    <path
      fill="currentColor"
...
const GalleryIcon = (props: SvgIconProps): JSX.Element => (
  <SvgIcon
    viewBox="0 0 24 24"
    sx={{ color: '#7c39ed', fontSize: '16px' }}
    {...props}
  >
    <path
      fill="currentColor"
...
const FormIcon = (props: SvgIconProps): JSX.Element => (
  <SvgIcon
    viewBox="0 0 24 24"
    sx={{ color: '#e929ba', fontSize: '16px' }}
    {...props}
  >
    <path
      fill="currentColor"
...
const viewIcons: Record<ViewSchemaType, (props: SvgIconProps) => JSX.Element> =
  {
    grid: GridIcon,
